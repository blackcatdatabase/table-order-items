...
use BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto as Dto;
use BlackCat\Database\Packages\OrderItems\Mapper\OrderItemDtoMapper as RowMapper;
...
use BlackCat\Database\Packages\OrderItems\Repository\OrderItemRepositoryInterface;
...
class OrderItemRepository implements OrderItemRepositoryInterface, RepoContract, KeysetRepoContract
{
use OrderByTools, PkTools, RepositoryHelpers;
     ...
     */
    protected function def(): string { return \BlackCat\Database\Packages\OrderItems\Definitions::class; }
    ...
    public function upsertMany(array $rows): int {
        ...
        if ($helperKeys && class_exists(\BlackCat\Database\Support\BulkUpsertHelper::class)) {
          $bulk = new \BlackCat\Database\Support\BulkUpsertHelper($this->db, \BlackCat\Database\Packages\OrderItems\Definitions::class);
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null */
    public function getByTenantIdAndId(int $tenantId, int $id, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null {
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null */
    public function getByIdForTenant(int|string $id, int|string $tenantId, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null {
