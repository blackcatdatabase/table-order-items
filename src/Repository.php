...
use BlackCat\Database\Packages\OrderItems\Repository\OrderItemRepository as GeneratedRepository;
...
final class Repository
{
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof OrderItemRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected OrderItemRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null { return $this->repo->getById($id, $asDto); }
