...
final class Repository
{
    ...
    {
        $this->repo = new OrderItemRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItems\Dto\OrderItemDto|null
    {
