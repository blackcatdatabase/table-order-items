...
final class OrderItemDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'order_id' => 'orderId', 'book_id' => 'bookId', 'product_ref' => 'productRef', 'title_snapshot' => 'titleSnapshot', 'sku_snapshot' => 'skuSnapshot', 'unit_price' => 'unitPrice', 'tax_rate' => 'taxRate' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'order_id', 'book_id', 'product_ref', 'quantity' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'order_id', 'book_id', 'product_ref', 'sku_snapshot' ];
