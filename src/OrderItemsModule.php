...
final class OrderItemsModule implements ModuleInterface {
    ...
    /** @return string[] */
    public function dependencies(): array { return [ 'table-books', 'table-orders' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_order_items_book_id', 'idx_order_items_order_id' ];
        $fks     = [ 'fk_order_items_book', 'fk_order_items_order' ];
        $missingIdx = [];
        $missingFk  = [];
