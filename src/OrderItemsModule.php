...
final class OrderItemsModule implements ModuleInterface
{
    public function name(): string { return 'table-order_items'; }
    public function table(): string { return 'order_items'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-books', 'table-orders', 'table-tenants' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_order_items_book_id', 'idx_order_items_order_id', 'idx_order_items_tenant_book', 'idx_order_items_tenant_order', 'ux_order_items_tenant_id' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_order_items_book_id', 'idx_order_items_order_id', 'idx_order_items_tenant_book', 'idx_order_items_tenant_order', 'ux_order_items_tenant_id' ],
