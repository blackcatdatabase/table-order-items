...
> Lineage: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 2 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\order-items](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\order-items) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package order-items -Apply
