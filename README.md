...
> Schema package for table **order_items** (repo: `order-items`).
...
## Relationships
- FK → **books** via (tenant_id,book_id) (ON DELETE SET NULL).
...
erDiagram
  ...
  ORDER_ITEMS }o--|| BOOKS : "tenant_id, book_id"
  ORDER_ITEMS }o--|| ORDERS : "tenant_id, order_id"
  ORDER_ITEMS }o--|| TENANTS : "tenant_id"
```
